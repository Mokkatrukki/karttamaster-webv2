...
// T403/V291/V298/V250: valinta → reititön tehtävä.
describe('MarkerOverviewPanel — valinta & tehtävän luonti (T403)', () => {
  ...
  it('(vi) V298: suodattimen ulkopuolinen rivi ⊥ ole valittavissa', () => {
    const h = mount({
      open: true,
      segments,
  ...
  it('V298: suodattimen muutos pudottaa kadonneen merkin valinnasta (⊥ näkymätön valinta)', () => {
...
describe('MarkerOverviewPanel — parity poistuneelle modaalille (T404)', () => {
  ...
  it('haussa piiloon jäänyt rivi putoaa valinnasta (V298 koskee myös hakua)', () => {
    const h = mount({
      open: true,
      segments,
