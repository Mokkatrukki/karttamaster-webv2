...
- ✅ **T265/V185/B107 (2026-07-21):** kartan pätkän pituus korjattu — `planSegmentZoom` fittaa nyt AINA koko pätkän [startDist,endDist]. Anchor-clamp (`maxFitLengthM=4000`) poistettu (näytti >4km pätkän "liian lyhyenä"). Käyttäjäpäätös: "fittaa aina koko pätkä". Vitest-pure vihreä.
