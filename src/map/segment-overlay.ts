...
import { segmentLineState, getPhaseProgress, segmentPrimaryRouteId } from '../logic/segments'
// T465: värikieli on oma moduulinsa (väri / status -jako, ⊥ "kaikki mikä liittyy viivaan").
import { segmentLineColor, assignSegmentColors, colorForSegment } from '../logic/segment-color'
