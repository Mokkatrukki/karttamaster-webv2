...
// T419: nimilapun zoom-käytös EI asu täällä. T418 piilotti lapun kynnyksellä (`segmentLabelVisible`
// + `MIN_SEGMENT_LABEL_ZOOM`) — käyttäjäpäätös 2026-07-30 kumosi sen: lappu ⊥ katoa milloinkaan,
// se KUTISTUU kuten merkki-ikoni. Kaari elää `src/logic/marker-scale.ts`:ssä merkkikaaren
// rinnalla (`segmentLabelScaleForZoom`) ∴ "sama kuin merkit" on tarkistettavissa yhdellä
// silmäyksellä. Tämä tiedosto vastaa vain kysymykseen "piirretäänkö lainkaan" (reittisuodatin).
