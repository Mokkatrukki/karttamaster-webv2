...
- **Paikkojen muokkaus** (T248, `.inv-loc-edit-toggle` "✎ Muokkaa" → `.inv-loc-editor`): rivi per paikka = nimi-`<input>` (Enter/blur → rename PUT) + "Poista" (confirm → DELETE, tavarat → "Ei paikkaa" V166). Näkyy vain jos paikkoja on.
