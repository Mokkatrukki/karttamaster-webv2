...
- **Valinta (T403):** checkbox `22×22px` `accent-color:var(--accent)`. `Suodattimen ulkopuolella` -rivit ovat valinnan ULKOPUOLELLA (V294) — bulk ⊥ saa koskea riviin jota käyttäjä ⊥ näe kartalla; suodattimen muutos pudottaa kadonneet id:t valinnasta & laskuri päivittyy.
