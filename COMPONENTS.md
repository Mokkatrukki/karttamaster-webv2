...
| GpsNavigator | `src/map/gps-navigator.ts` | ✓ T30, T341 (tilakone haetaan/päällä/pois + näkyvät virheet, V247), T397 (oma `gps`-pane z675 — piste yli pätkä-/reittiviivojen, V287/B166) | critical-paths: "GPS-paikannin" · t341-gps-no-segment | [map.md](docs/components/map.md) |
...
| MarkerOverviewPanel | `src/ui/marker-overview-panel.ts` | ✓ T402/T403 (telakoitu merkkijono järjestäjälle, korvaa `#marker-modal`in; oikea reuna ⊥ modaali koska rivin klikkaus panoroi karttaa V114; DESIGN §K) | tests/t402-marker-overview-panel.test.ts | [ui.md](docs/components/ui.md) |
