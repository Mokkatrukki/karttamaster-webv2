...
| InventoryPage | `inventory.html` + `src/inventory.ts` + `src/ui/inventory-page.ts` | ✓ T245 (v2: paikkatabit + määräsäädin −/+/tarkka + minimilisäys + tiedot-editori; resolveItemName V165; V163/V164; merkki-integraatio T246) | — | [ui.md](docs/components/ui.md) |
