...
| InventoryPage | `inventory.html` + `src/inventory.ts` + `src/ui/inventory-page.ts` | ✓ T242 (lisää/muokkaa/poista, V163 auth-gate, V164 textContent-XSS-esto; LeftPanel-linkki, nginx `/inventaario`) | — | [ui.md](docs/components/ui.md) |
