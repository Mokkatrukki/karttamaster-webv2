...
| SignIcon | `src/map/icons.ts` | ✓+B57+T138 (poistettu duplikoiva nurkkabadge, statusbadge isompi+glyfillinen) | critical-paths: "toolbar-dropdown" | [map.md](docs/components/map.md) |
