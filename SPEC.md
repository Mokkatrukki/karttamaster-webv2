...
| V39 | Backend-sessio on roolin lähde. Talkoolaiselle autentikoitu sessio on lukittu — `RoleSelector`-nappi ei saa näkyä kun `sessionRole === 'talkoolainen'`. `setRole()` ei saa ylikirjoittaa backend-roolia. |
